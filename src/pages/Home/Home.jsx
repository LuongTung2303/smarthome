...
import { useSocket } from "../../socket/SocketContext"; // Thêm dòng này

function Home() {
  const { socketData } = useSocket(); // Lấy dữ liệu từ context
  const humidity = socketData["sensor2"] || 0;
  const temperature = socketData["sensor1"] || 0;
